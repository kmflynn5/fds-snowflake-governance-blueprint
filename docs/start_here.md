...
A credible, working reference I can walk through on client and recruiter calls tomorrow
A publishable GitHub repo + blog post that demonstrates my governance philosophy
