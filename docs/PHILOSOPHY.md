...
integration. Functional roles (LOADER, TRANSFORMER, ANALYST) are conceptual
groupings used for auditing and documentation — not operational assignments.
...
`ANALYST`, `TRANSFORMER`, and all other connector roles cannot.
